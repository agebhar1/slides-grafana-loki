...
#
curl -L --silent https://github.com/docker/compose/releases/download/v5.1.1/docker-compose-linux-x86_64 -o ~/.docker/cli-plugins/docker-compose
...
# install Grafana xk6
#
GOBIN=~/.local/bin/ go install go.k6.io/xk6/cmd/xk6@v1.3.7
