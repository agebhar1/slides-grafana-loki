...
Vagrant.configure("2") do |config|
    ...
    config.vm.box_version = "1.0.20240503"
...
#
curl -L --silent https://github.com/docker/compose/releases/download/v2.27.0/docker-compose-linux-x86_64 -o ~/.docker/cli-plugins/docker-compose
