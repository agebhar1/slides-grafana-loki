...
#
curl -L --silent https://github.com/docker/compose/releases/download/v2.34.0/docker-compose-linux-x86_64 -o ~/.docker/cli-plugins/docker-compose
chmod +x ~/.docker/cli-plugins/docker-compose

#
# install Grafana logcli
#
curl -L --silent https://github.com/grafana/loki/releases/download/v2.9.14/logcli-linux-amd64.zip -o /tmp/logcli-linux-amd64.zip
...
# install Grafana xk6
#
GOBIN=~/.local/bin/ go install go.k6.io/xk6/cmd/xk6@v0.14.3
...
cd xk6-loki
git checkout e7ba343 # master/58 commits
make k6
mv k6 ~/.local/bin/k6
popd
...
#
MINIO_VERSION=2025-03-12T18-04-18Z
