...
#
curl -L --silent https://github.com/docker/compose/releases/download/v2.30.3/docker-compose-linux-x86_64 -o ~/.docker/cli-plugins/docker-compose
...
# install Grafana xk6
#
GOBIN=~/.local/bin/ go install go.k6.io/xk6/cmd/xk6@v0.13.2
...
#
MINIO_VERSION=2024-10-13T13-34-11Z
