...
#
curl -L --silent https://github.com/docker/compose/releases/download/v2.39.1/docker-compose-linux-x86_64 -o ~/.docker/cli-plugins/docker-compose
...
#
MINIO_VERSION=2025-07-21T05-28-08Z
