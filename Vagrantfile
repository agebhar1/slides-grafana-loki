...
Vagrant.configure("2") do |config|
    ...
    config.vm.box_version = "1.0.20240207"
...
zypper --non-interactive install git-core go1.21 make
...
#
curl -L --silent https://github.com/docker/compose/releases/download/v2.24.2/docker-compose-linux-x86_64 -o ~/.local/bin/docker-compose
chmod +x ~/.local/bin/docker-compose

#
# install Grafana logcli
#
curl -L --silent https://github.com/grafana/loki/releases/download/v2.9.4/logcli-linux-amd64.zip -o /tmp/logcli-linux-amd64.zip
...
# install Grafana xk6
#
GOBIN=~/.local/bin/ go install go.k6.io/xk6/cmd/xk6@v0.10.0
