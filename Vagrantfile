...
Vagrant.configure("2") do |config|
    ...
    config.vm.box_version = "1.0.20240517"
...
#
curl -L --silent https://github.com/docker/compose/releases/download/v2.27.1/docker-compose-linux-x86_64 -o ~/.docker/cli-plugins/docker-compose
