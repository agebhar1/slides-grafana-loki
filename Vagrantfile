...
Vagrant.configure("2") do |config|
    ...
    config.vm.box_version = "1.0.20240704"
...
#
curl -L --silent https://github.com/docker/compose/releases/download/v2.29.2/docker-compose-linux-x86_64 -o ~/.docker/cli-plugins/docker-compose
chmod +x ~/.docker/cli-plugins/docker-compose

#
# install Grafana logcli
#
curl -L --silent https://github.com/grafana/loki/releases/download/v2.9.10/logcli-linux-amd64.zip -o /tmp/logcli-linux-amd64.zip
...
# install Grafana xk6
#
GOBIN=~/.local/bin/ go install go.k6.io/xk6/cmd/xk6@v0.12.1
...
#
MINIO_VERSION=2024-07-29T22-14-52Z
