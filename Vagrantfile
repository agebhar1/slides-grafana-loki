...
zypper --non-interactive install git-core go1.25 make
...
#
curl -L --silent https://github.com/docker/compose/releases/download/v2.39.4/docker-compose-linux-x86_64 -o ~/.docker/cli-plugins/docker-compose
chmod +x ~/.docker/cli-plugins/docker-compose

#
# install Grafana logcli
#
curl -L --silent https://github.com/grafana/loki/releases/download/v2.9.15/logcli-linux-amd64.zip -o /tmp/logcli-linux-amd64.zip
...
# install Grafana xk6
#
GOBIN=~/.local/bin/ go install go.k6.io/xk6/cmd/xk6@v1.1.5
